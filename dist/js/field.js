...
var render = function() {
  ...
  return Array.isArray(_vm.field.value)
    ? _c("span", [_vm._v(_vm._s(_vm.field.value))])
    : _c("span", [
        _vm._v(
          _vm._s(
            _vm.field.options.find(function(item) {
              return item["value"] == _vm.field.value
            }).label
          ) +
            " " +
            _vm._s(this.label)
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        dynamicField: function dynamicField() {
            ...
            this.field.value = this.field.options.find(function (item) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("panel-item", { attrs: { field: this.dynamicField } })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addFlexibleContentPrefix: function addFlexibleContentPrefix(item, field) {
            var splitted = field.attribute.toLowerCase().split('__');
            return (splitted.length === 2 ? splitted[0] + '__' : '') + item;
        },
        removeFlexibleContentPrefix: function removeFlexibleContentPrefix(field) {
        ...
        fill: function fill(formData) {
            if (this.value) {
                if (Array.isArray(this.value)) {
                    formData.append(this.field.attribute, this.value.map(function (value) {
                        return value.value;
                    }));
                } else {
